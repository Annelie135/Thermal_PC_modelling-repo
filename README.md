...
Fusarium fungi were exposed to temperatures from 10 to 40°C to examine their fungal growth rate performance under different thermal conditions. Ten functions aimed at estimating thermal optima were fitted to radial growth rate data using the “rTPC” package (Padfield et al., 2025). 
